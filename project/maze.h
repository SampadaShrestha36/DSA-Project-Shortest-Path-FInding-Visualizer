...
#ifndef MAZE_H
#define MAZE_H //These prevent multiple inclusions of the same header file. If MAZE_H is not defined, the content between #ifndef and #endif will be included. If it's already defined, the content will be skipped
...
extern const int num; // constant integer representing the size of the grid 
extern int grid[60][60]; //2D array representing the maze where grid[i][j] holds the value of the cell 
